...
import { regulatoryComplianceTrack } from './themes/regulatory-compliance/track.js';
import { internalControlsTrack } from './themes/internal-controls/track.js';
...
export const themes = [
  ...
  { slug: 'regulatory-compliance', title: 'Regulatory Compliance', tagline: 'The Rulebook & the Referee', blurb: 'Playing by the laws — GDPR, SOX, HIPAA, DORA, and friends.', icon: '⚖️', accent: 'sky', status: 'live', track: regulatoryComplianceTrack },
  ...
  { slug: 'internal-controls', title: 'Internal Controls', tagline: 'Checks & Balances', blurb: 'The locks, keys, and second signatures that keep things honest.', icon: '🔐', accent: 'violet', status: 'live', track: internalControlsTrack },
  // ---- Wave 2 ----
  { slug: 'cyber-it-risk', title: 'Cyber & IT Risk', tagline: 'Guarding the Castle', blurb: 'Digital walls, gates, and spies — plus AI governance.', icon: '🏰', accent: 'sky', status: 'live', track: cyberItRiskTrack },
